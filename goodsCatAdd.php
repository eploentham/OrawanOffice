...
if (!isset($_SESSION['orc_user_staff_name'])) {
    ...
    $_SESSION['orc_page'] ="goodsCatAdd.php";
...
if ($rComp=mysqli_query($conn,$sql)){
    ...
    $gcId = $aCust["goods_cat_id"];
    //$cuCode = strval($aCust["cust_code"]);
    $gcName = strval($aCust["goods_cat_name"]);
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="" id="smart-form-register" class="smart-form">
                            ...
                            <fieldset>
                                <section>
                                    <label class="label">ชื่อชนิดสินค้า</label>
                                    <label class="input"> <i class="icon-append fa fa-user"></i>
                                        <input type="text" name="gcName" id="gcName" value="<?php echo $gcName;?>" placeholder="ชื่อชนิดสินค้า">
        ...
        function saveGodosCatagory(){
            ...
            $.ajax({ 
                ...
                data: { 'goods_cat_id': $("#gcId").val()
                    ,'goods_cat_name': $("#gcName").val()
                    ,'flagPage':"goodsCatagory"
                    }, 
