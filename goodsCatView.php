...
if (!isset($_SESSION['orc_user_staff_name'])) {
    ...
    $_SESSION['orc_page'] ="goodsCatView.php";
    echo "<script>window.location.assign('login.php');</script>";
}
$trCust="";
$conn = mysqli_connect($hostDB,$userDB,$passDB,$databaseName);
mysqli_set_charset($conn, "UTF8");
$sql="Select * From b_goods_catagory Where active = '1' ";
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<!-- end widget -->
                    <footer>
                        <button type="button" class="btn btn-primary" id="btnGoodsCatAdd">
                                    เพิ่ม ชนิดสินค้า
                        </button>
                    </footer>
		</article>
...
<script type="text/javascript">
	...
	loadScript("js/plugin/datatables/jquery.dataTables.min.js", function(){
        ...
        $("#btnGoodsCatAdd").click(showGoodsCatAdd);
        function showGoodsCatAdd(){
            //alert("aaaa");
            window.location.assign('goodsCatAdd.php');
        }
